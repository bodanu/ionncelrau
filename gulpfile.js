...
var paths = {
  ...
  vendor: {
    components: {
      ...
      nonJs: ["app/**/vendor/**/*", "!app/**/vendor/**/*.js"]
    },
  ...
  e2e: ["bower_components/lodash/dist/lodash.js", "tests-e2e/*.coffee"]
};
...
gulp.task(
  "app",
  gulp.parallel("html", "coffee", "json", "images", "sass", "less")
);

gulp.task("vendor:components:js", function() {
  return gulp
    .src(paths.vendor.components.js)
...
gulp.task("vendor:components:other", function() {
  return gulp
    .src(paths.vendor.components.nonJs)
...
gulp.task(
  "vendor:components",
  gulp.parallel("vendor:components:js", "vendor:components:other")
);

gulp.task("vendor:js", function() {
  return gulp
    .src(paths.vendor.bower.js)
...
gulp.task("vendor:fonts", function() {
  return gulp
    .src(paths.vendor.bower.fonts, { base: "bower_components" })
...
gulp.task(
  "vendor",
  gulp.parallel("vendor:components", "vendor:js", "vendor:css", "vendor:fonts")
);
...
gulp.task("flash:prod", function() {
  return gulp
    .src(paths.vendor.components.flash)
...
gulp.task("xml:prod", function() {
  return gulp
    .src(paths.vendor.components.xml)
